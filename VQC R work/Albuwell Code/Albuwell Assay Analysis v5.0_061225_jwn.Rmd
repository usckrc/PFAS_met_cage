...
ggplot(tidy_data_solved_dil_meta2, aes(x = Treatment, y = Alb, color = Timepoint)) +
  geom_point(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6), size = 3) +
  labs(title = "24h Albumin at Baseline and Endpoint by Treatment Group",
       x = "Treatment Group",
       y = "Albumin (mg)") +
  theme_minimal() +
  scale_color_manual(values = c("Baseline" = "#1f77b4", "Final" = "#ff7f0e"))

tidy_data_solved_dil_meta3 <- tidy_data_solved_dil_meta2  %>%
filter(Sample != '3934_Final')

ggplot(tidy_data_solved_dil_meta3, aes(x = Treatment, y = Alb, color = Timepoint)) +
  geom_point(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.6), size = 3) +
  labs(title = "24h Albumin at Baseline and Endpoint by Treatment Group",
       x = "Treatment Group",
       y = "Albumin (mg)") +

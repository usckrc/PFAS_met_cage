...
PFAS_1mg_BW <- read.xlsx(here("/Users/victoriaqc/Documents/GitHub/PFAS_met_cage/VQC R work/Data Sheets/PFAS_Rdata_1mg_BW.xlsx"))
PFAS_10mg_BW <- read.xlsx(here("/Users/victoriaqc/Documents/GitHub/PFAS_met_cage/VQC R work/Data Sheets/PFAS_Rdata_10mg_BW.xlsx"))


PFAS_meta <- read.xlsx(here("/Users/victoriaqc/Documents/GitHub/PFAS_met_cage/VQC R work/Data Sheets/PFAS_Sample_Meta.xlsx"))
...
ggplot(data = PFAS_1mg_BW_plot_5, aes(x = Timepoint, ymin = NormDown, ymax = NormUp, y = NormalizedMean, color = Drug, group = Drug, fill = Drug)) + 
  ...
  geom_rect(aes(xmin = "D-2" , xmax = "D1", ymin = -Inf, ymax = Inf), fill = "lightgray", alpha = 0.1, color = NA) +

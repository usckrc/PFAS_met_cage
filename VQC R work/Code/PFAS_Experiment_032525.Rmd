...
ggplot(data = PFAS_BW_plot_4, aes(x = Timepoint, ymin = NormDown, ymax = NormUp, y = NormalizedMean, color = Drug, group = Drug, fill = Drug)) + 
  ...
  geom_rect(aes(xmin = "45741" , xmax = "45749", ymin = -Inf, ymax = Inf), fill = "lightgray", alpha = 0.1, color = NA) +
  ...
  annotate("text", x = "45741", y = .88, label = "PFAS Concentration", hjust = 0.5, vjust = 0, size = 5, color = "black") +  # Adding the text
  theme_classic() +

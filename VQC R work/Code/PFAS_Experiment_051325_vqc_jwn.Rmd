...
ggplot(data = PFAS_water_plot_4, aes(x = Timepoint, ymin = NormDown, ymax = NormUp, y = NormalizedMean, color = Drug, group = Drug, fill = Drug)) + 
  ...
  theme_classic() +
  labs(x = "Timepoint", y = "Normalized Mean (grams)", title = "Water Consumption Over Study") +
    theme(
    axis.title.x = element_text(size = 14),  # Increase x-axis title size
    axis.title.y = element_text(size = 14),  # Increase y-axis title size
    axis.text.x = element_text(size = 12),    # Increase x-axis text size
...
PFAS_meta$Drug <- factor(PFAS_meta$Drug, levels = c("Vehicle", "PFAS_1mg", "PFAS_10mg"))


ggplot(data = PFAS_meta, aes(x = Drug, y = Kidney_Weight, color = Drug)) + 
  geom_point(size = 3) +
  theme_classic() +
...
ggplot(data = PFAS_meta, aes(x = Drug, y = Heart_Weight, color = Drug)) + 
  geom_point(size = 3) +
  theme_classic() +

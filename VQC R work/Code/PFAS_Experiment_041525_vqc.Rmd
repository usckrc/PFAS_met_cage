...
PFAS_food_plot_2$Timepoint <- factor(PFAS_food_plot_2$Timepoint, levels = c("W-1", "W0", "W1", "W2", "W3"))
...
PFAS_food_plot_4$Timepoint <- factor(PFAS_food_plot_4$Timepoint, levels = c("W-1", "W0", "W1", "W2", "W3"))
...
ggplot(data = PFAS_food_plot_4, aes(x = Timepoint, ymin = NormDown, ymax = NormUp, y = NormalizedMean, color = Drug, group = Drug, fill = Drug)) + 
  ...
  geom_rect(aes(xmin = "W0" , xmax = "W3", ymin = -Inf, ymax = Inf), fill = "lightgray", alpha = 0.1, color = NA) +
...
PFAS_water_plot_2$Timepoint <- factor(PFAS_water_plot_2$Timepoint, levels = c("W-1", "W0", "W1", "W2", "W3"))
...
PFAS_water_plot_4$Timepoint <- factor(PFAS_water_plot_4$Timepoint, levels = c("W-1", "W0", "W1", "W2", "W3"))
